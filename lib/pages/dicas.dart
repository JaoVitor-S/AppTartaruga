...
import '../api/wikipedia_api.dart';
import '../domain/curiosidade_wikipedia.dart';
...
class _DicasState extends State<Dicas> {
  late Future<CuriosidadeWikipedia> futureCuriosidade;

  @override
  void initState() {
    super.initState();
    futureCuriosidade = WikipediaApi().buscarCuriosidade();
  }
